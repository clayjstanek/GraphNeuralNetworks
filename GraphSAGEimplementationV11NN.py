...
initial_file_handler = logging.FileHandler('./logs/GraphSAGELog100823.log')
logger.addHandler(initial_file_handler)

formatter = logging.Formatter('%(asctime)s - %(levelname)s - %(message)s')
initial_file_handler.setFormatter(formatter)

logger.debug("This will be logged to 'GraphSAGELog100823.log'")
"""
logging.basicConfig(
...
class AutoEncoder(nn.Module):
    def __init__(self, input_dim=NODELEN*2, embedding_dim= 384, hidden_dim1=8192,
                 hidden_dim2=2048, p=0.2, num_epochs=100):
...
class GraphSAGEAutoencoder(nn.Module):
    def __init__(self, adjacency_list, nodes_feature_list, feature_keys,
                 ...
                 hidden_dim2=2048, p=.2, num_epochs=100):
        ...
        self.autoencoder = AutoEncoder(input_dim, embedding_dim, hidden_dim1, hidden_dim2, p, num_epochs)
