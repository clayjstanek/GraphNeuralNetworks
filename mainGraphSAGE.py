...
from GraphSAGEimplementationV11NN import Cosine_Similarity, GraphSAGEAutoencoder, convert_to_json_serializable, \
...
def main(args):
    ...
    graphsage = GraphSAGEAutoencoder(adjacency_list, nodes_feature_list, feature_keys,
                                     input_dim=NODELEN * 2, embedding_dim=384, hidden_dim1=hiddenlayer1,
                                     hidden_dim2=hiddenlayer2, p=p, num_epochs=num_epochs)
...
if __name__ == "__main__":
    ...
    parser.add_argument("graphfile", type=str,
                        ...
                        default='dgl_20230920.bin')
    parser.add_argument("--logfile", type=str, help="Name of Log File", default='GraphSageImplementation_20231008.log')
    parser.add_argument("--joblib_outputfile", type=str,
                        ...
                        default='sortedpairs_dgl_20230920.joblib')
    parser.add_argument("--json_outputfile", type=str,
                        ...
                        default='sortedpairs_dgl_20230920.json')
    parser.add_argument("--hidden_layer_1_nodes", type=int, help="Autoencoder hidden layer 1 size (default 8192)",
                        default=8192)
    parser.add_argument("--hidden_layer_2_nodes", type=int, help="Autoencoder hidden layer 2 size (default 1024)",
                        default=1024)
    parser.add_argument("--p", type=float, help="Autoencoder dropout rate >0, <1", default=.25)
