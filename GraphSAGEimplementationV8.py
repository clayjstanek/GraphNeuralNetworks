...
initial_file_handler = \
logging.FileHandler('C://Users/cstan/Documents/CooperStandard/tutorials/EUAIops/logs/GraphSAGELog092723.log')
logger.addHandler(initial_file_handler)

formatter = logging.Formatter('%(asctime)s - %(levelname)s - %(message)s')
initial_file_handler.setFormatter(formatter)

logger.debug("This will be logged to 'GraphSAGELog092723.log'")
"""
logging.basicConfig(
    ...
    filename="C://Users/cstan/Documents/CooperStandard/tutorials/EUAIops/logs/GraphSAGELog092723.log",
...
dump(sorted_node_pairs, './SortedNodePairs_DGL20230920.joblib')
"""
...
joblib_file = './SortedNodePairs_DGL20230920.joblib'
...
json_file = 'SortedNodePairs_DGL20230920.json'
